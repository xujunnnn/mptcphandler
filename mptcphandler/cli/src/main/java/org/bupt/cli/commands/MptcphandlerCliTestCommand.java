...
public class MptcphandlerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(MptcphandlerCliTestCommand.class);
    protected final MptcphandlerCliCommands service;

    public MptcphandlerCliTestCommand(final MptcphandlerCliCommands service) {
